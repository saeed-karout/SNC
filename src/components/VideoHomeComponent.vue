<template>
    <div class="relative h-screen z-20">
        <video v-if="videoBlobUrl" autoplay loop muted class="absolute inset-0 w-full h-full object-cover z-[-1]"
            preload="auto">
                ...
                <div class="text-center">
                    <div class="text-container">
                        <transition name="fade">
                            <h1 v-if="showText" key="text"
                                class="text-4xl font-semibold tracking-tight sm:text-6xl fade-text">{{ currentText }}
                            </h1>
                        </transition>
                    </div>
...
let intervalId; // تعريف intervalId في النطاق العام لـ setup
